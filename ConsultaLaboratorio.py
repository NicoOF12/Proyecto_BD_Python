...
class Laboratorio:
    ...
    def __init__(self, Ventana_i=None):
        ...
        Titulo = Label(Ventana_i,text="Laboratorio", fg="black", font=("Comic Sans", 17,"bold"),pady=10).pack()
        if Ventana_i is not None:  # Verificar si se proporcionó una ventana
            self.tree=ttk.Treeview(Ventana_i, height=13, columns=("columna1","columna2"))
