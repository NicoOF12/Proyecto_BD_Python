...
class Medico:
    """
    Clase que representa la interfaz gráfica para gestionar información de médicos.

    Atributos:
        db_name (str): Nombre de la base de datos utilizada.
        window (Tk | None): Referencia a la ventana principal de la aplicación.
        tree (ttk.Treeview): Tabla donde se muestran los datos de los médicos.
    """
    ...
    def __init__(self, Ventana_i=None):
        """
        Constructor de la clase Medico. Inicializa la ventana principal y la interfaz gráfica.
        ...
        if self.window is not None:
            ...
            Label(self.window, text="Médicos", fg="black", font=("Comic Sans", 17, "bold"), pady=10).pack()
            ...
            self.tree.heading("columna2", text='Especialidad', anchor=CENTER)
    ...
    def Obtener_Datos(self):
        ...
        # Consulta SQL para obtener los datos de la tabla "Medico"
